...
def make_prior_fn(task, automatic_transforms_enabled: bool = False):
    ...
    def prior_fn(rng, n, n_samples, f_in=None):
...
def make_simulator_fn(
    ...
    def simulator_fn(rng, params_dict, n, f_in=None):
...
def make_local_fn(task, automatic_transforms_enabled: bool = False, device='cpu'):
    ...
    def local_fn(rng, global_samples, n, f_in=None):
...
def run(
    ...
    **kwargs,
    ...
    batch_size = min(batch_size, n_samples_per_round)
